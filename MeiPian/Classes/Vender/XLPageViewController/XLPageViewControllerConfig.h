...
/**
 阴影距离边缘的距离 仅在XLPageShadowLineAlignmentBottom ｜ XLPageShadowLineAlignmentTop 模式下有效果 默认为 0
 */
@property (nonatomic,assign) CGFloat shadowLineDistanceToEdge;

/**
 标题栏左右按钮距离边缘的距离 默认为 0
 */
@property (nonatomic, assign) CGFloat btnDistanceToEdge;
