...
//    NSLog(@"value = %f proceess = %f offectX = %f width = %f",value,self.titleView.animationProgress,scrollView.contentOffset.x,scrollView.bounds.size.width);
}
...
- (void)setLeftButton:(UIButton *)leftButton {
    _titleView.leftButton = leftButton;
}
