...
@interface AppPageControl ()<AppPageControlDelegate>

@end

@implementation AppPageControl
...
-(void)setCurrentPage:(NSInteger)currentPage{
    ...
    if([self.delegate respondsToSelector:@selector(app_PageControlClick:index:)])
    {
        [self.delegate app_PageControlClick:self index:currentPage];
    }
