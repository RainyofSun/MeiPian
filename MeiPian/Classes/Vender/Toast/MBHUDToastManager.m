...
+(void)hideAlert{
    dispatch_async(dispatch_get_main_queue(), ^{
        MBProgressHUD *hud = [MBHUDToastManager HUDForView:gloomyView];
#if 1
...
+ (void)hideAlertDelay:(int64_t)time {
