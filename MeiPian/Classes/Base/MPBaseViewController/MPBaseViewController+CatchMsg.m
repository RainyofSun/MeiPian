//
//  MPBaseViewController+CatchMsg.m
//  MeiPian
//
...
#import "MPBaseViewController+CatchMsg.h"
#import "RuntimeTool.h"
#import "MPBackupMessage.h"

@implementation MPBaseViewController (CatchMsg)
...
+ (BOOL)resolveClassMethod:(SEL)sel{
    ...
    if ([NSStringFromSelector(sel) isEqualToString:@"modulesSendMsg:"]) {
        /**
...
-(id)forwardingTargetForSelector:(SEL)aSelector{
    if ([NSStringFromSelector(aSelector) isEqualToString:@"modulesSendMsg:"]) {
        return [MPBackupMessage new];
    }
...
-(void)forwardInvocation:(NSInvocation *)anInvocation{
    //创建备用对象
    MPBackupMessage * backUp = [MPBackupMessage new];
